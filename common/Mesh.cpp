...
void Mesh::Draw(GLShader& shader, Camera& camera, glm::mat4 matrix, glm::vec3 translation, glm::quat rotation, glm::vec3 scale)
{
	...
	glUniform3f(glGetUniformLocation(shader.GetProgram(), "camPos"), camera.Position.x, camera.Position.y, camera.Position.z);
